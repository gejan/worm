...
local function register_worm(modname, name, leftover, face, side, tail, can_move)
	minetest.register_craftitem(modname..":"..name.."_spawnegg", {
		...
		on_use = function(itemstack, user, pointed_thing)
			...
			local player_dir = vector.multiply(user:get_look_dir(), -1)
...
local worm_leftover = "mapgen_dirt"
